...
getTotal(5,"add"); // 15
getTotal(10,"add"); // 55
getTotal(5,"multiply"); //120
getTotal(10,"multiply"); // 3628800
getTotal(100);
...
for(var index in _cars){
    console.log(_cars[Number(index)]);
}
...
// function searchIndex(string,number){
//     while(string,number){
//         console.log(index);
//     }
...
function getMaxValue(array1){
    for(i = 0; i < array1.length; i++){
        if(typeof array1[i]==='number'){
        arr1.push(array1[i]);
        comparenumber = arr1[0];
        
    }if(array1[i] > comparenumber)
    {
        comparenumber = arr1[i];
        maxnumber = i
    }
}
return maxnumber;
}
getMaxValue([19, 23, -14, 100, "hello", "world"]);
